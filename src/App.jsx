...
function App() {
  ...
  return (
    <div className="relative w-full min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-pink-200 via-purple-200 to-rose-200 p-4">
      ...
      {/* Background decoration (Statik, performans dostu arka plan ışıkları) */}
      <div className="absolute top-[-10%] left-[-10%] w-64 md:w-96 h-64 md:h-96 bg-pink-400/40 rounded-full filter blur-3xl pointer-events-none"></div>
      <div className="absolute top-[-10%] right-[-10%] w-64 md:w-96 h-64 md:h-96 bg-purple-400/40 rounded-full filter blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-[-20%] left-[20%] w-64 md:w-96 h-64 md:h-96 bg-rose-400/40 rounded-full filter blur-3xl pointer-events-none"></div>
