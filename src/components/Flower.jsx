        ...
        {indices.map((i) => {
          ...
          return (
            <g 
              ...
              className="opacity-25 brightness-50"
            >
              <path
                d="M 200 200 
        ...
        {indices.map((i) => {
          ...
          return (
            <g 
              ...
              className="cursor-pointer transition-all duration-700 ease-in-out hover:brightness-110"
              style={{ 
                opacity: isClicked ? 1 : 0.6,
                filter: isClicked ? 'none' : 'saturate(50%) brightness(75%)'
              }}
            >
